...
let MessagesData = {
    ...
    [id2]: {mid: id2,date: new Date().toGMTString(), subject : "hi",body: "hi sravan self mail",fullName : "sravan", fromMail : "sravan@email.com", to:["sravan@email.com"],cc:[], unread:["sravan@email.com","bala@email.com"]},
}
let ToData = [
